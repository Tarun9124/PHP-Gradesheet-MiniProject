...
<body>
    ...
    <section class="main">
        <div class="login-container">
            ...
            <form class="login-form" action="AddAdmin.php" method="post">
                <div class="myform-control">
                    <input type="number" name="id" placeholder="Unique ID" required />
            ...
            if ($cn) {
                try {
                    if (isset($_POST['add'])) {
                        ...
                        $sql = "INSERT INTO admin VALUES ('" . $_POST['id'] . "','" . $_POST['name'] . "','" . $hashpwd . "','" . $_POST['email'] . "')";
                        if (mysqli_query($cn, $sql)) {
                            echo '<div id="msg"><h1 style="color:green";>Admin Added!<h1></div>';
                            echo '<script>setTimeout(function(){ document.getElementById("msg").style.display = "none"; }, 2000);</script>';
                        } else {
                            echo '<div id="message"><h1 style="color:red";>Admin Not Added!<h1></div>';
